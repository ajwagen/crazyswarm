...
class ControllerBackbone():
    ...
    #    [ 1.8827,  0.7237,  0.2655,  1.0013,  0.0217]])
                # weights generated using mppi_no_policy_3fans_speed3_may_8_trial_*.npz (first 4 trials only, 5th out of battery)
                self.A_hat = torch.tensor([[  0.3288,   1.5870,   0.4887,   2.9642,   1.4855],
        [  0.9332,   4.2388,  -4.4929,   2.1394,   0.7213],
        [ 0, 0 , 0,   0,   0]])
