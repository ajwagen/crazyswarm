...
class Trajectories:
    def __init__(self, init_pos=np.array([0.,0.,0.]), gui = False):
        ...
        self.random_chained_poly_obj = ChainedPolyRef(altitude=0.0, use_y=False, seed=0)
        self.random_chained_poly_fast_obj = ChainedPolyRefFast(altitude=0.0, use_y=False, seed=0)
