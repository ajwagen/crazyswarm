...
class ctrlCF():
    ...
    def write_to_log(self):
        ...
        if not self.isSim:
            ...
            LOG_DIR = os.path.dirname(os.path.abspath(__file__)) + "/../../../../../logs/icra2023_sysid/oct_20/real/"
            ...
            LOG_DIR = os.path.dirname(os.path.abspath(__file__)) + "/../../../../../logs/icra2023_sysid/oct_20/sim/"
