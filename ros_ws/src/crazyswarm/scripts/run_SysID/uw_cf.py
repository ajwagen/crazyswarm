...
class ctrlCF():
    ...
    def write_to_log(self):
        ...
        if not self.isSim:
            ...
            LOG_DIR = os.path.dirname(os.path.abspath(__file__)) + "/../../../../../logs/icra2023_sysid/sep_11/real/"
            ...
            LOG_DIR = os.path.dirname(os.path.abspath(__file__)) + "/../../../../../logs/icra2023_sysid/sep_11/sim/"
